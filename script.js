...
//criar a função para criar o próximo nível do jogo
let nextLevel = () => {
    score++;
    shuffleOrder();
}

//criar a função para o fim de jogo
let gameOver = () => {
...
//criar a função para iniciar o jogo
let playGame = () => {
...
//criar os eventos de cliques para as cores
